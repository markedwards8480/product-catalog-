...
function getHTML() {
    ...
    html += 'document.getElementById("resetAllFiltersBtn").addEventListener("click",function(){console.log("Reset button clicked - setting to medium view");document.getElementById("searchInput").value="";document.getElementById("minQty").value="";document.getElementById("maxQty").value="";currentFilter="all";colorFilter=null;specialFilter=null;minColorsFilter=0;customerStyleFilter=null;currentSort="qty-high";currentSize="medium";qtyMode="left_to_sell";document.getElementById("sortSelect").value="qty-high";document.querySelectorAll(".filter-btn").forEach(function(b){b.classList.remove("active")});var allBtn=document.querySelector(".filter-btn[data-cat=\\"all\\"]");if(allBtn)allBtn.classList.add("active");document.querySelectorAll(".filter-btn[data-special]").forEach(function(b){b.classList.remove("active")});document.getElementById("colorFilterBtn").textContent="Color: All ▼";document.getElementById("clearColorBtn").classList.add("hidden");document.querySelectorAll(".size-btn").forEach(function(b){b.classList.remove("active")});var medBtn=document.querySelector(".size-btn[data-size=\\"medium\\"]");if(medBtn){medBtn.classList.add("active");console.log("Medium button found and activated")}else{console.log("Medium button NOT found!")};var grid=document.getElementById("productGrid");console.log("Grid class before:",grid.className);grid.className="product-grid size-medium";console.log("Grid class after:",grid.className);document.querySelectorAll(".qty-toggle-btn").forEach(function(b){b.classList.remove("active")});document.getElementById("toggleLeftToSell").classList.add("active");document.getElementById("availNowStat").classList.remove("stat-active");document.getElementById("leftToSellStat").classList.add("stat-active");renderProducts();console.log("Grid class after render:",document.getElementById("productGrid").className)});';
