...
function getHTML() {
    ...
    html += '.reset-all-btn{padding:0.5rem 1.25rem;border:2px solid #dc2626;background:#fff;color:#dc2626;border-radius:8px;cursor:pointer;font-weight:600;font-size:0.8125rem;transition:all 0.2s}.reset-all-btn:hover{background:#dc2626;color:white}';
