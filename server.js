...
function getHTML() {
    ...
    html += '.header{background:white;padding:1rem 2rem;border-bottom:1px solid #ddd;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;position:sticky;top:0;z-index:50;transition:all 0.3s ease}.header.compact{padding:0.5rem 2rem;box-shadow:0 2px 8px rgba(0,0,0,0.1)}.header.compact h1{font-size:1rem}.header.compact .header-right{gap:0.5rem}.header h1{font-size:1.25rem;transition:font-size 0.3s}.header-right{display:flex;gap:1rem;align-items:center;transition:gap 0.3s}';
    ...
    html += '.view-controls{display:flex;align-items:center;gap:1rem;margin-bottom:1rem;padding:0.75rem 1rem;background:white;border-radius:8px;flex-wrap:wrap;position:sticky;top:110px;z-index:30;transition:all 0.3s ease}.view-controls.compact{padding:0.5rem 1rem;gap:0.5rem;top:85px}.view-controls label{font-weight:500;color:#333}';
