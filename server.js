...
function getHTML() {
    ...
    html += 'var currentSalesFilter="all";var currentSalesHistory=[];function loadSalesHistory(styleId){currentSalesFilter="all";document.getElementById("salesHistoryLoading").textContent="(loading...)";document.getElementById("salesHistorySummary").innerHTML="";document.getElementById("salesHistoryFilter").innerHTML="";document.getElementById("salesHistoryList").innerHTML="<div style=\\"color:#666;padding:0.5rem\\">Loading...</div>";fetch("/api/sales-history/"+encodeURIComponent(styleId)).then(function(r){return r.json()}).then(function(d){document.getElementById("salesHistoryLoading").textContent="";if(!d.success){document.getElementById("salesHistoryList").innerHTML="<div style=\\"color:#999;padding:0.5rem\\">Unable to load</div>";return}currentSalesHistory=d.history;var sum=d.summary;var invDollars=sum.totalInvoicedDollars?"$"+sum.totalInvoicedDollars.toLocaleString(undefined,{minimumFractionDigits:2,maximumFractionDigits:2}):"";var openDollars=sum.totalOpenOrdersDollars?"$"+sum.totalOpenOrdersDollars.toLocaleString(undefined,{minimumFractionDigits:2,maximumFractionDigits:2}):"";var poDollars=sum.totalPODollars?"$"+sum.totalPODollars.toLocaleString(undefined,{minimumFractionDigits:2,maximumFractionDigits:2}):"";document.getElementById("salesHistorySummary").innerHTML="<div onclick=\\"filterSalesHistory(\'invoiced\')\\" style=\\"flex:1;padding:1rem;background:#e8f5e9;border-radius:8px;cursor:pointer;border:2px solid transparent;text-align:center\\" class=\\"sales-tile\\" data-filter=\\"invoiced\\"><div style=\\"font-size:1.5rem;font-weight:bold;color:#2e7d32\\">"+sum.totalInvoiced.toLocaleString()+"</div><div style=\\"font-size:0.8rem;color:#666;margin:0.25rem 0\\">Invoiced ("+sum.invoiceCount+")</div>"+(invDollars?"<div style=\\"font-size:0.9rem;font-weight:600;color:#2e7d32\\">"+invDollars+"</div>":"")+"</div><div onclick=\\"filterSalesHistory(\'open\')\\" style=\\"flex:1;padding:1rem;background:#fff3e0;border-radius:8px;cursor:pointer;border:2px solid transparent;text-align:center\\" class=\\"sales-tile\\" data-filter=\\"open\\"><div style=\\"font-size:1.5rem;font-weight:bold;color:#ef6c00\\">"+sum.totalOpenOrders.toLocaleString()+"</div><div style=\\"font-size:0.8rem;color:#666;margin:0.25rem 0\\">Open SO ("+sum.openOrderCount+")</div>"+(openDollars?"<div style=\\"font-size:0.9rem;font-weight:600;color:#ef6c00\\">"+openDollars+"</div>":"")+"</div><div onclick=\\"filterSalesHistory(\'po\')\\" style=\\"flex:1;padding:1rem;background:#e3f2fd;border-radius:8px;cursor:pointer;border:2px solid transparent;text-align:center\\" class=\\"sales-tile\\" data-filter=\\"po\\"><div style=\\"font-size:1.5rem;font-weight:bold;color:#1565c0\\">"+(sum.totalPO||0).toLocaleString()+"</div><div style=\\"font-size:0.8rem;color:#666;margin:0.25rem 0\\">Import PO ("+(sum.poCount||0)+")</div>"+(poDollars?"<div style=\\"font-size:0.9rem;font-weight:600;color:#1565c0\\">"+poDollars+"</div>":"")+"</div>";renderSalesHistoryList(d.history)}).catch(function(err){document.getElementById("salesHistoryLoading").textContent="";document.getElementById("salesHistoryList").innerHTML="<div style=\\"color:#999\\">Error: "+err.message+"</div>"})}';
