...
function getHTML() {
    ...
    html += 'function removeCategoryFromPanel(){selectedCategories=[];renderCommodityBar();updateFilterPanel();renderProducts()}';
