...
function getHTML() {
    ...
    // Commodity bar visualization
    html += '.commodity-bar-container{padding:0 2.5rem;margin-bottom:1rem}.commodity-bar{display:flex;height:36px;border-radius:8px;overflow:hidden;background:#f5f5f7;cursor:pointer}.commodity-segment{display:flex;align-items:center;justify-content:center;padding:0 8px;font-size:0.7rem;font-weight:600;color:white;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;transition:all 0.2s;min-width:0;position:relative}.commodity-segment:hover{filter:brightness(1.1)}.commodity-segment.active{box-shadow:inset 0 0 0 3px rgba(255,255,255,0.8)}.commodity-segment span{overflow:hidden;text-overflow:ellipsis}.commodity-bar-label{font-size:0.7rem;color:#86868b;margin-bottom:0.25rem;display:flex;justify-content:space-between;align-items:center}.commodity-bar-label .metric{font-weight:600;color:#1e3a5f}';
    ...
    html += '<div class="commodity-bar-container"><div class="commodity-bar-label"><span>Inventory by Category</span><span class="metric" id="commodityMetricLabel">Left to Sell</span></div><div class="commodity-bar" id="commodityBar"></div></div>';
