...
function getHTML() {
    ...
    // Apple-style buttons
    html += '.btn{padding:0.75rem 1.5rem;border:none;border-radius:980px;cursor:pointer;font-size:0.875rem;font-weight:400;transition:all 0.2s;letter-spacing:-0.01em}.btn-primary{background:#1e3a5f;color:white}.btn-primary:hover{background:#2a4a6f}.btn-secondary{background:transparent;color:#1e3a5f;padding:0.5rem 1rem}.btn-secondary:hover{background:rgba(0,113,227,0.04)}.btn-danger{background:#ff3b30;color:white}.btn-danger:hover{background:#ff453a}.btn-success{background:#34c759;color:white}.btn-success:hover{background:#30d158}';
    ...
    html += '.tabs{display:flex;gap:0.25rem;margin-bottom:1.5rem;flex-wrap:wrap}.tab{padding:0.625rem 1rem;border:none;background:transparent;cursor:pointer;border-radius:980px;color:#1e3a5f;font-size:0.875rem;font-weight:400;transition:all 0.2s}.tab:hover{background:rgba(0,0,0,0.04)}.tab.active{background:#1e3a5f;color:white}';
    ...
    html += '.qty-toggle{display:flex;background:#f5f5f7;border-radius:980px;padding:3px;margin-left:auto}.qty-toggle-btn{padding:0.5rem 1.25rem;border:none;background:transparent;cursor:pointer;font-size:0.8125rem;font-weight:500;border-radius:980px;transition:all 0.2s;color:#6e6e73}.qty-toggle-btn.active{background:white;color:#1e3a5f;box-shadow:0 1px 4px rgba(0,0,0,0.1)}.qty-toggle-btn:hover:not(.active){color:#1e3a5f}';
    ...
    html += '.filter-btn.special{padding:0.5rem 1rem;border:none;background:transparent;border-radius:980px;cursor:pointer;color:#1e3a5f;font-size:0.9375rem;font-weight:600;transition:all 0.2s;margin-right:0.5rem}.filter-btn.special:hover{background:rgba(0,0,0,0.04)}.filter-btn.special.active{background:#1e3a5f;color:white}';
    ...
    html += '.filter-btn{padding:0.4rem 0.875rem;border:none;background:transparent;border-radius:980px;cursor:pointer;color:#6e6e73;font-size:0.8125rem;font-weight:400;transition:all 0.2s}.filter-btn:hover{background:rgba(0,0,0,0.04);color:#1e3a5f}.filter-btn.active{background:#1e3a5f;color:white;font-weight:500}';
    ...
    html += '.color-count-badge{position:absolute;top:12px;right:12px;background:#1e3a5f;color:white;padding:0.25rem 0.625rem;border-radius:980px;font-size:0.7rem;font-weight:500;z-index:5}';
    ...
    html += '.size-btn{padding:0.5rem 1rem;border:none;background:transparent;cursor:pointer;color:#1e3a5f;font-size:0.8125rem;font-weight:500;transition:all 0.2s;border-radius:6px}.size-btn:hover{background:rgba(0,0,0,0.04)}.size-btn.active{background:#1e3a5f;color:white}';
    ...
    html += '.share-result{margin-top:1rem;padding:1rem;background:#f5f5f7;border-radius:12px}.share-result a{color:#1e3a5f;word-break:break-all}';
    ...
    html += '.select-mode-btn{padding:0.5rem 1rem;border:none;background:transparent;color:#1e3a5f;border-radius:980px;cursor:pointer;font-weight:400;font-size:0.875rem;transition:all 0.2s}.select-mode-btn:hover{background:rgba(0,113,227,0.04)}.select-mode-btn.active{background:#1e3a5f;color:white}';
    html += '.feature-toggle{display:inline-flex;align-items:center;margin:0 1rem;background:#f5f5f7;border-radius:980px;padding:3px;border:none}.feature-toggle input{display:none}.feature-toggle label{padding:0.5rem 1rem;border-radius:980px;cursor:pointer;font-size:0.8125rem;font-weight:400;color:#86868b;transition:all 0.2s}.feature-toggle input:checked+label{background:#1e3a5f;color:white}';
