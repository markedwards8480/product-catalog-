...
function getHTML() {
    ...
    html += 'document.getElementById("resetAllFiltersBtn").addEventListener("click",function(){console.log("Reset clicked");document.getElementById("searchInput").value="";document.getElementById("minQty").value="";document.getElementById("maxQty").value="";currentFilter="all";colorFilter=null;specialFilter=null;minColorsFilter=0;customerStyleFilter=null;currentSort="qty-high";currentSize="medium";qtyMode="left_to_sell";document.getElementById("sortSelect").value="qty-high";document.querySelectorAll(".filter-btn[data-cat]").forEach(function(b){b.classList.remove("active")});var allCatBtn=document.querySelector(".filter-btn[data-cat=\\"all\\"]");if(allCatBtn)allCatBtn.classList.add("active");document.querySelectorAll(".filter-btn[data-special]").forEach(function(b){b.classList.remove("active")});document.getElementById("colorFilterBtn").textContent="Color: All ▼";document.getElementById("clearColorBtn").classList.add("hidden");document.querySelectorAll(".size-btn").forEach(function(b){b.classList.remove("active")});var medBtn=document.querySelector(".size-btn[data-size=\\"medium\\"]");if(medBtn)medBtn.classList.add("active");document.querySelectorAll(".qty-toggle-btn").forEach(function(b){b.classList.remove("active")});document.getElementById("toggleLeftToSell").classList.add("active");document.getElementById("availNowStat").classList.remove("stat-active");document.getElementById("leftToSellStat").classList.add("stat-active");renderProducts();document.getElementById("productGrid").className="product-grid size-medium";console.log("Reset complete, grid class:",document.getElementById("productGrid").className)});';
