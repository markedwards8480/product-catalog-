...
function getHTML() {
    ...
    html += '.main{max-width:1200px;margin:0 auto;padding:2rem}';
    // Admin panel
    ...
    // Stats bar - Apple minimal style
    html += '.stats{display:flex;gap:2.5rem;margin-bottom:0;padding:1.25rem 2rem;background:#fff;align-items:center;flex-wrap:wrap;position:sticky;top:48px;z-index:90;border-bottom:1px solid rgba(0,0,0,0.04)}.stats.compact{padding:0.75rem 2rem;top:44px}.stat-value{font-size:1.75rem;font-weight:600;color:#1d1d1f;letter-spacing:-0.02em}.stat-label{color:#86868b;font-size:0.75rem;font-weight:400;text-transform:none;letter-spacing:0;margin-top:0.125rem}.stat-box{padding:0;transition:all 0.2s ease}.stat-box.stat-active .stat-value{color:#1d1d1f}.stat-box:not(.stat-active){opacity:0.4}.feature-toggle.active-indicator{background:transparent}';
    // Qty toggle - Apple pill style
    html += '.qty-toggle{display:flex;background:#f5f5f7;border-radius:980px;padding:3px;margin-left:auto}.qty-toggle-btn{padding:0.5rem 1rem;border:none;background:transparent;cursor:pointer;font-size:0.75rem;font-weight:400;border-radius:980px;transition:all 0.2s;color:#86868b}.qty-toggle-btn.active{background:white;color:#1d1d1f;box-shadow:0 1px 4px rgba(0,0,0,0.08)}.qty-toggle-btn:hover:not(.active){color:#1d1d1f}';
    // Filters - Apple style pills (like All products / Laptops / Desktops)
    html += '.filters{display:flex;gap:0.25rem;margin-bottom:1.5rem;flex-wrap:wrap;align-items:center;padding:0 2rem}.filter-btn{padding:0.5rem 1rem;border:none;background:transparent;border-radius:980px;cursor:pointer;color:#1d1d1f;font-size:0.875rem;font-weight:400;transition:all 0.2s}.filter-btn:hover{background:rgba(0,0,0,0.04)}.filter-btn.active{background:#1d1d1f;color:white}';
    // Color dropdown - Apple clean style
    html += '.color-dropdown{position:absolute;top:100%;left:0;background:rgba(255,255,255,0.98);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:none;border-radius:12px;box-shadow:0 4px 24px rgba(0,0,0,0.12);padding:0.5rem;z-index:100;max-height:300px;overflow-y:auto;min-width:180px}.color-dropdown.hidden{display:none}.color-option{display:block;padding:0.625rem 1rem;cursor:pointer;border-radius:8px;font-size:0.875rem;color:#1d1d1f}.color-option:hover{background:rgba(0,0,0,0.04)}.color-option.active{background:#0071e3;color:white}';
    // Product grid - Apple spacing
    html += '.product-grid{display:grid;gap:2rem;padding:0 2rem}.product-grid.size-small{grid-template-columns:repeat(auto-fill,minmax(200px,1fr))}.product-grid.size-medium{grid-template-columns:repeat(auto-fill,minmax(280px,1fr))}.product-grid.size-large{grid-template-columns:repeat(auto-fill,minmax(380px,1fr))}.product-grid.size-list{display:flex;flex-direction:column;gap:0.5rem}';
    ...
    html += '.product-image{height:260px;background:#f5f5f7;display:flex;align-items:center;justify-content:center;overflow:hidden}.product-image img{max-width:90%;max-height:90%;object-fit:contain}';
    // Product info - Apple clean typography
    html += '.product-info{padding:1.25rem;text-align:center}.product-style{font-size:0.7rem;color:#86868b;text-transform:none;letter-spacing:0}.product-name{font-size:1rem;font-weight:600;margin:0.375rem 0;color:#1d1d1f;letter-spacing:-0.01em}.color-list{margin-top:0.75rem;text-align:left}.color-row{display:flex;justify-content:space-between;padding:0.25rem 0;font-size:0.8rem;color:#1d1d1f}.total-row{margin-top:0.75rem;padding-top:0.75rem;border-top:1px solid #f5f5f7;font-weight:600;display:flex;justify-content:space-between;color:#1d1d1f;font-size:0.9rem}';
    ...
    // View controls - Apple style
    html += '.view-controls{display:flex;align-items:center;gap:1.5rem;margin-bottom:0;padding:0.875rem 2rem;background:#fff;flex-wrap:wrap;position:sticky;top:106px;z-index:80;border-bottom:1px solid rgba(0,0,0,0.04)}.view-controls.compact{padding:0.625rem 2rem;top:92px}.view-controls label{font-weight:400;color:#86868b;font-size:0.8125rem}';
    html += '.size-btn{padding:0.5rem 1rem;border:none;background:transparent;cursor:pointer;color:#1d1d1f;font-size:0.8125rem;transition:all 0.2s;border-radius:6px}.size-btn:hover{background:rgba(0,0,0,0.04)}.size-btn.active{background:#1d1d1f;color:white}';
