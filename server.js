...
function getHTML() {
    ...
    html += '.header{background:white;padding:1rem 2rem;border-bottom:1px solid #ddd;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;position:sticky;top:0;z-index:100;transition:all 0.3s ease}.header.compact{padding:0.5rem 2rem;box-shadow:0 2px 8px rgba(0,0,0,0.1)}.header.compact h1{font-size:1rem}.header.compact .header-right{gap:0.5rem}.header h1{font-size:1.25rem;transition:font-size 0.3s}.header-right{display:flex;gap:1rem;align-items:center;transition:gap 0.3s}';
    ...
    html += '.stats{display:flex;gap:2rem;margin-bottom:1rem;padding:1rem;background:white;border-radius:8px;align-items:center;flex-wrap:wrap;transition:all 0.3s ease}.stats.compact{padding:0.5rem 1rem;gap:1rem}.stats.compact .stat-value{font-size:1.1rem}.stats.compact .stat-label{font-size:0.7rem}.stat-value{font-size:1.5rem;font-weight:bold;transition:font-size 0.3s}.stat-label{color:#666;font-size:0.875rem;transition:font-size 0.3s}';
    ...
    html += '.view-controls{display:flex;align-items:center;gap:1rem;margin-bottom:1rem;padding:0.75rem 1rem;background:white;border-radius:8px;flex-wrap:wrap;transition:all 0.3s ease}.view-controls.compact{padding:0.5rem 1rem;gap:0.5rem}.view-controls label{font-weight:500;color:#333}';
    ...
    html += '<div class="stats"><div><div class="stat-value" id="totalStyles">0</div><div class="stat-label">Styles</div></div><div><div class="stat-value" id="totalAvailNow">0</div><div class="stat-label">📦 Avail Now</div></div><div><div class="stat-value" id="totalLeftToSell">0</div><div class="stat-label">📊 Left to Sell</div></div><div class="qty-toggle"><button class="qty-toggle-btn active" id="toggleAvailableNow" data-mode="available_now">📦 Available Now</button><button class="qty-toggle-btn" id="toggleLeftToSell" data-mode="left_to_sell">📊 Left to Sell</button></div></div>';
    html += '<div class="view-controls"><label>View:</label><button class="size-btn" data-size="list">List</button><button class="size-btn" data-size="small">Small</button><button class="size-btn active" data-size="medium">Medium</button><button class="size-btn" data-size="large">Large</button><div class="feature-toggle" id="groupByStyleWrapper"><input type="checkbox" id="groupByStyleToggle"><label for="groupByStyleToggle">🎨 Group by Style</label></div><label>Sort:</label><select id="sortSelect" style="padding:0.4rem;border:1px solid #ddd;border-radius:4px"><option value="name-asc">Name A-Z</option><option value="name-desc">Name Z-A</option><option value="qty-high">Qty High→Low</option><option value="qty-low">Qty Low→High</option><option value="newest">Newest First</option></select><span style="margin-left:1rem"></span><label>Qty:</label><input type="number" id="minQty" placeholder="Min" style="width:70px;padding:0.4rem;border:1px solid #ddd;border-radius:4px"><span style="margin:0 0.25rem">-</span><input type="number" id="maxQty" placeholder="Max" style="width:70px;padding:0.4rem;border:1px solid #ddd;border-radius:4px"><button id="resetQtyBtn" style="margin-left:0.5rem;padding:0.4rem 0.75rem;border:1px solid #ddd;background:#f5f5f5;border-radius:4px;cursor:pointer;font-size:0.875rem">Reset</button><span style="margin-left:auto"></span><button class="select-mode-btn" id="selectModeBtn">📤 Select for Sharing</button></div>';
